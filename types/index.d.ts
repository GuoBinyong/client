...
export default class Client {
    ...
    //用户保存各个子类的单例
    // static _onlyInstanceMap:{[prop:string]:Client} ;

    //获取当前子类的单例
    static get onlyInstance():Client;
     ...
     *
     */
    static test(asyn?:false):Client|null;
    static test(asyn:true):Promise<Client>;
     ...
     */
    satisfiesVersionRange(versionRange:string,version?:string):boolean;
     ...
     * isSatisfyingVersionRange ： 表示客户端版本是否符合版本范围 versionRange 的限制； 如果 版本version 或 版本范围versionRange 无效，则了会返回 true ，表示符合版本范围的要求
     */
    get isSatisfyingVersionRange():boolean;
     ...
     */
    dispatchClientEvent(eventName:string,data?:any):void;
     ...
     */
    static asynTest(resolve:(value?:any) => void, reject: (reason?: any) => void):void;
    ...
    */
     ...
     */
    versionRangeMap:{[prop:string]:string};
